...
An R package for robust test statistics in structural equation models, covering both overall fit and nested model comparison. Built on top of `lavaan`. Implements the *p*-values of (Foldnes, Moss, Grønneberg, 2024).
