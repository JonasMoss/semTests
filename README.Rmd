...
The eigenvalue correction targets the limiting null law of the test statistic, a weighted sum of chi squares. This law holds for any minimum discrepancy estimator, so support now reaches beyond normal theory ML to GLS, ULS, categorical WLSMV/DWLS, and FIML missing data fits. See `?semTests-support` for the full validated matrix.
