...
MAR-like mechanism. It is only a teaching device and says nothing about a real
missingness process.
...
A small p-value would be evidence that the linear shape is too stiff. A large
one means this comparison has not found a clear reason to bend the trajectory.
