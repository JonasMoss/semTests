...
That little record is useful when several kinds of models end up in the same
analysis.
...
2001 construction is unavailable in this release, so `method = "2001"` points
you back to `"2000"`.
...
A quick preflight check catches many avoidable surprises:
