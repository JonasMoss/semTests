...
spectrum differently. If the 2001 construction produces materially negative
leading eigenvalues, semTests stops and asks you to inspect the fits or use
method 2000; it never silently changes methods.
...
5. use nested methods only for genuinely nested models; semTests verifies fit
